...
const themeColors = {
  // Primary Colors
  primary: '#0a3426ff',        // سبز اصلی (هم‌رنگ Tokyo)
  primaryLight: '#0a3426ff',   // سبز روشن (هم‌رنگ Tokyo)
  primaryDark: '#063022ff',    // سبز تیره
...
export default function BacktestApp({ onBack, isSharedView = false, sharedBacktestData = null, mt5Mode = false }) {
  // Authentication
              ...
              <div>
                <h1 className="text-lg font-bold flex items-center gap-2">
                  <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 text-transparent bg-clip-text">
                    Top In Trade / Forex Trading Journal
                  </span>
                </h1>
                <p className="text-xs text-gray-400">
                  Track your Forex trades with MT5
              ...
              {currentUser && !isSharedView && (
                <div className="relative">
                  <button
                    ...
                    className="bg-green-900 hover:bg-green-600 p-2 rounded-lg text-sm font-medium transition"
                  >
                    ...
                    <div className="absolute right-full mr-2 top-0 flex items-center gap-2 z-50">
                      ...
                      {!false && (
                        <button
                          ...
                          className="bg-green-900 hover:bg-green-600 px-4 py-2 rounded-lg text-sm font-medium transition flex items-center gap-2 whitespace-nowrap shadow-xl"
                        >
                      ...
                      {folder.isExpanded && (
                        <div className="pl-6 pr-2 pb-2 space-y-1">
                          {fbt.length === 0 ? <div className="text-xs text-gray-500 italic py-2 pl-2">Empty folder</div> : fbt.map(bt => {
                            ...
                            return (
                              <div key={bt.id} className={`flex items-center justify-between gap-2 px-3 py-2 rounded-lg text-sm cursor-pointer transition group ${currentBacktest === bti ? 'bg-green-500 text-white' : 'bg-gray-700/50 text-gray-300 hover:bg-gray-600/50'}`}>
            ...
            <div className="bg-gray-800/50 backdrop-blur rounded-xl border border-gray-700 p-4 mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-6 gap-3 mb-3">
                <div>
                  ...
                  <div className="relative flex items-center gap-1">
                    <input 
                      ...
                      className="flex-1 bg-gray-900 border border-gray-700 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:border-green-500 text-white" 
                    />
                ...
                <div>
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className="w-full bg-gray-900 border border-gray-700 rounded-lg px-3 py-1.5 pr-16 text-sm focus:outline-none focus:border-green-500 text-white" 
                    />
                    <select 
                      ...
                      className="absolute right-1 top-1/2 -translate-y-1/2 bg-gray-800 border border-gray-600 rounded px-2 py-1 text-xs focus:outline-none focus:border-green-500 text-white"
                    >
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-gray-900 border border-gray-700 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:border-green-500 text-white" 
                  />
                </div>
                <div>
              ...
              <div className="mb-3">
                ...
                <div className="relative tag-input-container">
                  <div className="flex flex-wrap gap-1.5 w-full bg-gray-900 border border-gray-700 rounded-lg px-2 py-1.5 text-sm focus-within:border-green-500 min-h-[38px] items-center">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {savedTags.map((tag, idx) => {
                      ...
                      return (
                        ...
                        >
                          <span className={`text-sm ${isPinned ? 'text-orange-300 font-semibold' : 'text-green-300'}`}>{tag}</span>
                          {isPinned && (
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="text-xs px-3 py-1 bg-green-500 hover:bg-green-600 rounded transition"
                      >
              ...
              <div className="glass-card rounded-xl p-4">
                <div className="flex flex-col gap-3 mb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <input type="text" placeholder="Search..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="bg-gray-900 border border-gray-700 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:border-green-500 w-48 text-white" />
                  </div>
                  <div className="flex flex-wrap items-center gap-2">
                    <select
                      ...
                      className="bg-gray-900 border border-gray-700 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:border-green-500 text-white"
                    >
                        ...
                        <div className="flex items-center gap-3 flex-1 w-full sm:w-auto">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap items-center gap-2 text-xs text-gray-400 mt-1">
                              ...
                              {trade.tag && <span className="px-2 py-0.5 rounded bg-green-500/20 text-green-400">#{trade.tag}</span>}
                              {trade.screenshotUrl && (
                                <button 
                ...
                <div className="glass-card rounded-xl p-6 border border-gray-700">
                  ...
                  <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-700">
                    ...
                    <select
                      ...
                      className="bg-gray-800 border border-gray-600 rounded-lg px-4 py-2 text-sm focus:outline-none focus:border-green-500 text-white"
                    >
                      {(() => {
                        const months = [];
                        const now = new Date();
                        ...
                        days.push(
                          <div
                            ...
                            className={`aspect-square p-3 rounded-xl border-2 transition-all hover:scale-105 ${
                              isToday
                                ? 'bg-gradient-to-br from-green-500/30 to-emerald-500/30 border-green-500 shadow-lg shadow-green-500/20'
                                : duration > 0
                          ...
                          >
                            <div className="flex flex-col h-full">
                              <div className="text-center mb-auto">
                                <p className={`text-2xl font-bold ${isToday ? 'text-green-300' : 'text-white'}`}>
                                  {day}
                                </p>
                              </div>
                              {duration > 0 && (
                      ...
                      {(() => {
                        ...
                        return (
                          <>
                            ...
                            <div className="text-center p-4 bg-green-500/10 rounded-lg border border-green-500/30">
                              <p className="text-xs text-green-300 mb-2 font-medium">Avg per Day</p>
                              <p className="text-3xl font-bold text-green-400">
                                {Math.floor(avgPerDay / 60000)}m
                              </p>
                              <p className="text-sm text-green-300 mt-1">average</p>
                            </div>
                          </>
                        );
                      })()}
        ...
        <div>
          ...
          <div className="flex gap-3">
            <button 
              ...
              className={`flex-1 py-2 rounded-lg font-medium ${newBacktest.balanceType === 'fixed' ? 'bg-green-500 text-white' : 'bg-gray-700 text-gray-300'}`}
            >
              Fixed
            </button>
            <button 
              onClick={() => setNewBacktest({...newBacktest, balanceType: 'dynamic'})} 
              className={`flex-1 py-2 rounded-lg font-medium ${newBacktest.balanceType === 'dynamic' ? 'bg-green-500 text-white' : 'bg-gray-700 text-gray-300'}`}
            >
              Dynamic
            </button>
          </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1.5 w-full bg-gray-900 border border-gray-700 rounded-lg px-2 py-1.5 text-sm focus-within:border-green-500 min-h-[38px] items-center">
            {(editingTrade.selectedTags || []).map((tag, idx) => (
              <div
                key={idx}
                className="group relative flex items-center gap-1.5 px-2.5 py-1 bg-green-500/20 border border-green-500/40 rounded text-xs text-green-300"
              >
                <span>{tag}</span>
                <button
                  onClick={(e) => {
